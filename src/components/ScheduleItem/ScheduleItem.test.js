...
test("Renders App component with default page", () => {
  const { container } = customRender(<ScheduleItem header="header" subHeader="subheader" description="lorem ipsum" />);
  expect(container).toMatchSnapshot();
});

it("description should not render on load", () => {
  customRender(<ScheduleItem header="header" subHeader="subheader" description="lorem ipsum" />);
...
it("should render the translation buttons if there is an alternate description", () => {
  const { container } = customRender(<ScheduleItem header="header" subHeader="subheader" description="lorem ipsum" descriptionAlt="alternate desc" />);
