  ...
  return (
    <Layout eventId={eventId} fontType={1}>
      ...
      <div className="about__content">
        ...
        <Paragraph className="about__content-text" text="The first thing to know is that we play music on instruments (or replicas) from the time the music was written.
      ...
      <div className="about__content">
        ...
        <Paragraph className="about__content-text" text="Our Orchestra was founded in 1986. Then, a group of idealistic period instrument players was determined to free itself from the shackles of working under an all-powerful music director and take charge of their own destiny.
